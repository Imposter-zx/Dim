...
PLATFORM_TRIPLES = {
    ...
    "wasm32": 'target triple = "wasm32-unknown-unknown"',
    "wasm64": 'target triple = "wasm64-unknown-unknown"',
}
...
PLATFORM_DATALAYOUTS = {
    ...
    "wasm32": 'target datalayout = "e-m:e-p:32:32-i64:64-n32:64-S128"',
    "wasm64": 'target datalayout = "e-m:e-p:64:64-i64:64-n32:64-S128"',
}
...
class LLVMGenerator:
    ...
    def generate(self, module: MIRModule) -> str:
        self._output = [
            ...
            "declare double @dim_runtime_sin(double)",
            "declare double @dim_runtime_cos(double)",
            "declare double @dim_runtime_tan(double)",
            "declare double @dim_runtime_sqrt(double)",
            "declare double @dim_runtime_pow(double, double)",
            "declare double @dim_runtime_log(double)",
            "declare double @dim_runtime_log10(double)",
            "declare double @dim_runtime_exp(double)",
            "declare double @dim_runtime_floor(double)",
            "declare double @dim_runtime_ceil(double)",
            "declare double @dim_runtime_round(double)",
            "declare double @dim_runtime_fabs(double)",
            "declare double @dim_runtime_PI()",
            "declare double @dim_runtime_E()",
            "",
            "; String operations (extended)",
            "declare i1 @dim_runtime_str_contains(i8*, i8*)",
            "declare i1 @dim_runtime_str_starts_with(i8*, i8*)",
            "declare i1 @dim_runtime_str_ends_with(i8*, i8*)",
            "declare i32 @dim_runtime_str_index_of(i8*, i8*)",
            "declare i8* @dim_runtime_str_replace(i8*, i8*, i8*)",
            "declare i32 @dim_runtime_str_split(i8*, i8*, i8**)",
            "declare i8* @dim_runtime_str_join(i8**, i32, i8*)",
            "declare i8* @dim_runtime_str_repeat(i8*, i32)",
            "",
            "; Memory management (reference counting)",
            "declare i8* @dim_alloc_ref(i64)",
            "declare void @dim_inc_ref(i8*)",
            "declare void @dim_dec_ref(i8*)",
            "declare void @dim_gc_register_root(i8*)",
            "declare void @dim_gc_collect()",
            "",
            "; Concurrency",
            "declare i32 @dim_thread_pool_init(i32)",
            "declare void @dim_thread_pool_submit(i8* (i8*)*, i8*)",
            "declare void @dim_thread_pool_shutdown()",
            "",
            "; Async/Futures",
            "declare i8* @dim_future_new()",
            "declare void @dim_future_await(i8*)",
            "declare void @dim_future_resolve(i8*, i8*)",
            "",
            "; Panic",
